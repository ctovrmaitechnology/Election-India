# Interactive Map of Arunachal Pradesh

This package generates an interactive SVG map of Arunachal Pradesh. It allows users to highlight districts on hover and retrieve the value of the selected district.

![Preview](https://raw.githubusercontent.com/arav-ind/svgmaps-india/refs/heads/master/gifs/arunachalpradesh.gif)
...
```bash
pnpm install svgmap-arunachalpradesh
```
...
export const districtNames = {
    ...
    UPP: 'Upper Siang',
    LOW: 'Lower Siang',
    UDV: 'Upper Dibang Valley',
    LDV: 'Lower Dibang Valley',
    SIA: 'Siang',
    SYH: 'Shi Yomi',
    PKA: 'Pakke Kessang',
    WSE: 'West Siang',
...
import ArunachalpradeshMap, { districtNames } from 'svgmap-arunachalpradesh'
